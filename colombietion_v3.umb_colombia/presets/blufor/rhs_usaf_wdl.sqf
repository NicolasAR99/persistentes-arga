...
*/
FOB_typename = "land_gm_euro_factory_02";                                    // This is the main FOB HQ building.
FOB_box_typename = "B_Slingload_01_Cargo_F";                            // This is the FOB as a container.
FOB_truck_typename = "rhsusf_M1078A1P2_B_WD_CP_fmtv_usarmy";            // This is the FOB as a vehicle.
Arsenal_typename = "B_supplyCrate_F";                                   // This is the virtual arsenal as portable supply crates.
Respawn_truck_typename = "rhsusf_M1232_MC_M2_usmc_d";   // This is the mobile respawn (and medical) truck.
huron_typename = "ACFAA_EA_CH47F_Unarmed";                                          // This is Spartan 01, a multipurpose mobile respawn as a helicopter.
...
KP_liberation_recycle_building = "Land_Ind_Garage01";           // The building defined to unlock FOB recycling functionality.
...
air_vehicles = [
    ...
    ["B_Plane_CAS_01_dynamicLoadout_F",500,1000,400],                                         // A-10C Thunderbolt II
    ["RHS_Ka52_vvsc",650,1050,450],                                         // F-15C Eagle
    ["RHS_Mi24V_vdv",750,1050,250],                                         // F-15D Eagle
    ["rhs_mi28n_vvs",1250,1300,450],                                         // F-15E Strike Eagle
    ["RHS_TU95MS_vvs_old",3200,3250,3250],                                      // F/A-18 E Super Hornet
    ["rhs_mig29s_vmf",1500,1750,450],                                      // F/A-18 F Super Hornet
    ["ACFAA_Gripen_NG",600,600,200],                                         // F-22A Raptor
    ["acfaa_t6a",300,500,200],                                  // F-22A Raptor (EWP-AA)
