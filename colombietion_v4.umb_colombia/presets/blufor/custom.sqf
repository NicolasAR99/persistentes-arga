...
FOB_typename = "land_gm_euro_factory_02";                                    // Poner el CLASSNAME del edificio que quieras
...
huron_typename = "ACFAA_EA_CH47F_Unarmed";                                          // This is Spartan 01, a multipurpose mobile respawn as a helicopter. PALOMA 01 TIENE Q TENER TORQUE SUFICIENTE PARA LEVANTAR LA CAJA GRANDE O REEMPLAZAR POR CAJA CHICA
...
heavy_vehicles = [
    ...
    ["gm_gc_army_t55am2b",300,400,250],
