...
GRLIB_vulnerability_timer = 3000;                                       // Time in seconds how long a captured sector is vulnerable to enemy troops.
...
KP_liberation_convoy_ambush_duration = 2000;                            // Duration of the convoy ambush event. (seconds)

KP_liberation_resistance_tier2 = 50;                                    // At which strength (0-100) the guerilla forces will be at tier 2?
KP_liberation_resistance_tier3 = 85;                                    // At which strength (0-100) the guerilla forces will be at tier 3?
