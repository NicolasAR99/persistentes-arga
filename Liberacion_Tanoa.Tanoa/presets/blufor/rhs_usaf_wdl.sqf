...
infantry_units = [
    ...
    ["rhsusf_army_ocp_javelin",50,10,0],                                // AT 
    ["rhsusf_army_ocp_aa",50,10,0],                                     // AA
...
light_vehicles = [
    ...
    ["rhsusf_m998_w_2dr_halftop",100,0,50],                             // M1097A2 (2D / Abierto)
    ...
    ["rhsusf_M1083A1P2_wd_fmtv_usarmy",125,0,75],                       // M1083A1P2 Transport (Cubierto)
...
air_vehicles = [
    ...
    ["B_UAV_06_F",80,0,30],                                             // AL-6 Pelican (Carga)
    ["RHS_MELB_MH6M",200,0,100],                                        // MH-6M Little Bird
    ["RHS_MELB_AH6M",200,200,100],                                      // AH-6M Pawnee
    ["RHS_UH1Y_UNARMED",225,0,125],                                     // UH-1Y (Desarmado)
    ["RHS_UH1Y_GS",225,200,125],                                        // UH-1Y (Supresion terrestre)
    ["RHS_AH1Z",500,500,200],                                           // AH-1Z
    ["RHS_AH64D_wd",750,750,250],                                       // AH-64D
    ["RHS_UH60M2",250,0,150],                                           // UH-60M (Desarmado)
    ["RHS_UH60M",250,80,150],                                           // UH-60M
    ["RHS_UH60M_MEV2",300,0,150],                                       // UH-60M MEV2
    ["RHS_CH_47F_10",275,80,175],                                       // CH-47 Chinook (Armado)
    ...
    ["B_T_VTOL_01_armed_F",750,1500,500],                               // V-44 X Blackfish (Armado)
    ["B_T_VTOL_01_infantry_F",750,0,500],                               // V-44 X Blackfish (Tropas)
    ["B_T_VTOL_01_vehicle_F",750,0,500]                                 // V-44 X Blackfish (Vehiculos)
];
