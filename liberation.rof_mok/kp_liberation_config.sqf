...
GRLIB_save_key = "KP_ARGA_" + (toUpper worldName) + "_SAVEGAME";
...
KP_liberation_cr_kill_penalty = 7;                                      // Civil Reputation penalty for killing a civilian.
...
KP_liberation_cr_resistance_penalty = 7;                                // Civil Reputation penalty for killing a friendly resistance soldier.
