...
GRLIB_secondary_missions_costs = [10, 8, 5];                           // Intel price for the secondary missions [FOB hunting, Convoy ambush, SAR].
...
KP_liberation_civinfo_chance = 50;                                      // Civil Informant spawn chance. (0-100)
...
KP_liberation_resistance_tier3 = 50;                                    // At which strength (0-100) the guerilla forces will be at tier 3?
...
KP_liberation_resistance_ambush_chance = 10;                            // Chance that some guerilla units will spawn in blufor sectors for an ambush, if reputation is low.
