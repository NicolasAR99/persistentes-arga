...
GRLIB_fob_range = 220;                                                  // Build range around the main FOB building.
...
GRLIB_vulnerability_timer = 3600;                                       // Time in seconds how long a captured sector is vulnerable to enemy troops.
...
KP_liberation_cr_resistance_penalty = 4;                                // Civil Reputation penalty for killing a friendly resistance soldier.
KP_liberation_cr_sector_gain = 10;                                       // Civil Reputation gain for liberate a sector.
KP_liberation_cr_wounded_chance = 30;                                   // Chance (0-100) that there are wounded civilians right after capturing a sector.
KP_liberation_cr_wounded_gain = 3;                                      // Civil Reputation gain for providing medical assistance for wounded civilians.

KP_liberation_civinfo_min = 7200;                                       // Civil Informant minimum spawn time. (seconds)
...
KP_liberation_civinfo_duration = 1600;                                  // Civil Informant staytime until despawning. (seconds)
KP_liberation_civinfo_task_chance = 20;                                 // Chance (0-100) that the delivered informant will spawn a time critical task.
...
KP_liberation_convoy_ambush_duration = 1600;                            // Duration of the convoy ambush event. (seconds)

KP_liberation_resistance_tier2 = 40;                                    // At which strength (0-100) the guerilla forces will be at tier 2?
KP_liberation_resistance_tier3 = 80;                                    // At which strength (0-100) the guerilla forces will be at tier 3?
...
KP_liberation_resistance_ambush_chance = 20;                            // Chance that some guerilla units will spawn in blufor sectors for an ambush, if reputation is low.
