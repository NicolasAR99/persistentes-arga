...
GRLIB_arsenal_weapons = [
    ...
    "rhsusf_weap_MP7A2_folded_desert"                               // MP7A2 Folded
];

GRLIB_arsenal_magazines = [
    "ACE_HuntIR_M203",                                // HuntIr 
    "1Rnd_HE_Grenade_shell",                                // granada 40 
    "ACE_SpareBarrel",                                // canon repuesto 
    "RPG32_F",                                       // rpg at
    "RPG32_HE_F",                                       // rpg he
...
GRLIB_arsenal_items = [
    // Uniforms
    "arga_u_gen3_desierto_multicam",                                           // arga
    "arga_u_gen1_oliva_liso",                                           // arga recluta
    ...
    // Headgear
    "arga_cas_combate_desierto_multicam",                                           // arga
    "arga_cas_helicoptero_abierto_medico",                                           // pil
    "arga_cas_tanquista_manchas",                                           // tank
    "arga_cas_ligero_oliva_liso",                                           // recluta
    ...
    // Vests
    "arga_c_pesado_desierto_multicam",                                    // Chaleco Arga
    "arga_c_ligero_oliva_liso",                                    // Chaleco Arga Recluta
    ...
    "adv_aceSplint_splint",                                        // splint
    "adv_aceCPR_AED",                                        // Defribrilator
...
GRLIB_arsenal_backpacks = [
    ...
    "arga_m_asalto_desierto_multicam",                                              // mochila l arga
    "arga_m_petate_desierto_multicam",                                              // mochila l arga
    "arga_m_campo_oliva_liso",                                              // mochila l arga
