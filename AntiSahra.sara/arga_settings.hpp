...
#define NAME "Antistasi Sarahni"                  // Colocar nombre de mision
#define COMPLETE_NAME "Antistasi Sarahni V1.0" // Nombre y versión de la misión
...
INSIGNIA_AUTOMATICA = 0;                            // 1: Añade insignias por pelotón o médicas, 0: No Añade.
