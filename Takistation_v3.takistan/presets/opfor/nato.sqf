...
opfor_officer = "B_Captain_Jay_F";                                          // Officer
...
opfor_vehicles = [
    ...
    "RHS_M2A3_BUSKI",                                            // Bardelas
    "LOP_IA_M1A1_AIM_D",                                                // Merkava Mk IV M
...
opfor_battlegroup_vehicles = [
    "B_MRAP_01_hmg_F",                                                  // M-ATV (HMG)
    "RHS_M2A3_BUSKI",                                                  // M-ATV (GMG)
    "RHS_M2A3_BUSKI",                                                  // M-ATV (GMG)
    "B_LSV_01_AT_F",                                                    // Polaris DAGOR (Mini-Spike PZAbw)
    "B_Truck_01_transport_F",                                           // HEMTT Transport
    "rhsusf_stryker_m1126_mk19_wd",                                             // HEMTT Transport (Covered)
    "B_APC_Tracked_01_rcws_F",                                          // Namer
    "B_APC_Tracked_01_rcws_F",                                          // Namer
    "B_APC_Tracked_01_AA_F",                                            // Bardelas
    "B_APC_Tracked_01_AA_F",                                            // Bardelas
    ...
    "B_MBT_01_cannon_F",                                                // Merkava Mk IV M
    "rhsusf_m1a1aim_tuski_d",                                                  // Merkava Mk IV LIC
    "rhsusf_m1a1aim_tuski_d",                                                  // Merkava Mk IV LIC
...
opfor_battlegroup_vehicles_low_intensity = [
    "B_MRAP_01_hmg_F",                                                  // M-ATV (HMG)
    "B_Heli_Light_01_dynamicLoadout_F",                                                  // M-ATV (HMG)
    "B_Truck_01_transport_F",                                           // HEMTT Transport
    "B_APC_Wheeled_01_cannon_F",                                        // SPz Badger
    "B_APC_Tracked_01_rcws_F",                                          // Namer
    "B_APC_Tracked_01_AA_F",                                            // Bardelas
